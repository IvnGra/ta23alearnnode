...
<template>
    <div class="columns">
        <div class="column is-3 has-background-primary has-text-center">
            <h1 class="is-size-1"><b>Cookies: {{ +cookies.toFixed(1) }}</b></h1>
            <h3 class="is-size-1"><b>CPS: {{ +cps.toFixed(1) }}</b></h3>
            <figure class="image is-square m-5">
                <img @click="cookies++" src="https://pbs.twimg.com/profile_images/1097261642205794309/xwM8hg09_400x400.png" alt="">
            </figure>
        </div>
